--  Com'Art – Script de création et alimentation de la BDD
--  Base : comart
...
CREATE TABLE Devis (
    ...
    CONSTRAINT chk_date_acceptation CHECK (
...
CREATE TABLE Prestation (
    ...
    numeroContrat   VARCHAR(50),
    FOREIGN KEY (numeroContrat) REFERENCES Contrat(numeroContrat) ON DELETE CASCADE,
    CONSTRAINT chk_prestation_dates CHECK (
        dateEffective IS NULL OR dateEffective >= datePrevue
    )
);
...
('PARTICULIER', 'Descartes', 'René',   NULL,             '76 Rue du Panthéon, 75005 Paris',           '0123456789', 'rene.descartes@email.com',  'ANCIEN'),
...
('CONT-2026-001', '2026-01-01', '12 mois',  12, 'MENSUELLE',    1500.00, 'Paiement en 3 fois',       1),
('CONT-2026-002', '2026-02-15', '6 mois',    6, 'MENSUELLE',    2000.00, 'Paiement comptant',        2),
('CONT-2026-003', '2026-03-01', '24 mois',  24, 'ANNUELLE',     3500.00, 'Paiement en 10 fois',      3),
('CONT-2026-004', '2026-01-10', '3 mois',    3, 'HEBDOMADAIRE', 1200.00, 'Paiement à la livraison',  4),
('CONT-2026-005', '2026-04-01', '12 mois',  12, 'MENSUELLE',    2800.00, 'Paiement en 4 fois',       5),
('CONT-2026-006', '2026-02-20', '9 mois',    9, 'MENSUELLE',    1800.00, 'Paiement en 2 fois',       6),
('CONT-2026-007', '2026-03-15', '1 mois',    1, 'MENSUELLE',     900.00, 'Paiement comptant',        7),
('CONT-2026-008', '2026-01-25', '18 mois',  18, 'ANNUELLE',     4000.00, 'Paiement en 6 fois',       8),
('CONT-2026-009', '2026-05-01', '6 mois',    6, 'MENSUELLE',    3000.00, 'Paiement en 3 fois',       9),
('CONT-2026-010', '2026-02-01', '12 mois',  12, 'MENSUELLE',    2200.00, 'Paiement en 5 fois',      10);
...
('Préparation du matériel', '2026-02-14 10:00:00', NULL,                    2, 'PREVUE',   1, 1),
('Retouches photos',        '2026-03-02 14:00:00', '2026-03-02 14:00:00',   3, 'TERMINEE', 3, 2),
('Repérage lieu',           '2026-04-09 11:00:00', NULL,                    1, 'PREVUE',   6, 3),
('Installation studio',     '2026-01-19 09:00:00', '2026-01-19 09:00:00',   1, 'TERMINEE', 1, 4),
('Brief client',            '2026-05-14 10:00:00', NULL,                    2, 'PREVUE',   2, 5),
('Prise de vue produits',   '2026-03-04 15:00:00', NULL,                    4, 'EN_COURS', 8, 6),
('Sélection photos',        '2026-03-26 10:00:00', '2026-03-26 10:00:00',   2, 'TERMINEE', 7, 7),
('Montage vidéo',           '2026-02-11 09:00:00', NULL,                    5, 'EN_COURS', 4, 8),
('Préparation album',       '2026-05-31 14:00:00', NULL,                    3, 'PREVUE',   5, 9),
('Livraison photos',        '2026-03-11 16:00:00', '2026-03-11 16:00:00',   1, 'TERMINEE', 3, 10);


--  Facture 
INSERT INTO Facture (numeroFacture, dateEmission, montantTotal, etat, numeroContrat) VALUES
('FACT-2026-001', '2026-01-15', 1500.00, 'EN_ATTENTE',          'CONT-2026-001'),
('FACT-2026-002', '2026-02-20', 2000.00, 'PAYEE',               'CONT-2026-002'),
('FACT-2026-003', '2026-03-10', 3500.00, 'EN_ATTENTE',          'CONT-2026-003'),
...
('FACT-2026-009', '2026-05-10', 3000.00, 'PARTIELLEMENT_PAYEE', 'CONT-2026-009'),
('FACT-2026-010', '2026-02-15', 2200.00, 'PAYEE',               'CONT-2026-010');

--  Paiement 
INSERT INTO Paiement (datePaiement, montantPaye, numeroFacture) VALUES
-- PAYEE
('2026-02-13', 2000.00, 'FACT-2026-002'),
('2026-01-26', 1200.00, 'FACT-2026-004'),
('2026-03-02', 1800.00, 'FACT-2026-006'),
('2026-02-16', 2200.00, 'FACT-2026-010'),
-- PARTIELLEMENT_PAYEE 
('2026-03-22',  400.00, 'FACT-2026-007'),
('2026-04-10',  300.00, 'FACT-2026-007'),
('2026-05-12', 1500.00, 'FACT-2026-009'),
('2026-06-01',  800.00, 'FACT-2026-009');
-- EN_ATTENTE : aucun paiement enregistré (FACT-001, 003, 005, 008)
