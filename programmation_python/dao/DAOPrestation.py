...
class DAOPrestation:
    ...
    def insert_Prestation(self, prestation):
        id_val = prestation.get_id_prestation()
        if id_val is not None:
            sql = "INSERT INTO Prestation (idPrestation, datePrevue, dateEffective, lieu, type, nbPhotosPrevues, nbVideosPrevues, numeroContrat) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
            values = (id_val, prestation.get_date_prevue(), prestation.get_date_effective(), prestation.get_lieu(),
                      prestation.get_type(), prestation.get_nb_photos_prevues(), prestation.get_nb_videos_prevues(), prestation.get_numero_contrat())
        else:
            ...
            values = (prestation.get_date_prevue(), prestation.get_date_effective(), prestation.get_lieu(),
                      prestation.get_type(), prestation.get_nb_photos_prevues(), prestation.get_nb_videos_prevues(), prestation.get_numero_contrat())
        try:
